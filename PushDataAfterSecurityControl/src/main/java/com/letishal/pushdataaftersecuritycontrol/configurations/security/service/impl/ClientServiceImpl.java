...
public class ClientServiceImpl extends EntityServiceImpl<Client, Long> {
    ...
    public Optional<Client> findById(Long id) {
        return super.findById(id).filter(e -> !e.getRole().equals("ADMIN"));
    }

    public Optional<Client> save(Client entity) {
        Optional<Client> userFromDB = ((ClientRepository) clientRepository).findByUserNickName(entity.getUserNickName());
